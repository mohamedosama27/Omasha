            ...
            <form method="POST" action="{{ route('user.update', ['id' => $user->id]) }}">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control @error('email') is-invalid @enderror" name="email"
                        value="{{ $user->email }}" type="email" placeholder="Email" name="email" required
                ...
                <div class="input-group">
                    ...
                    <input class="form-control @error('phone') is-invalid @enderror" type="text"
                        placeholder="Phone Number" value="{{ $user->phone }}" name="phone" required>
                </div>
                ...
                <button type="submit" class="w3-btn btn-block w3-round-xxlarge brandcolor">
                    Edit
                </button>
                <br>
            </form>
