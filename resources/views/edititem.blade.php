...
@section('content')
    ...
    <div class="container raleway">
        ...
        <form method="POST" action="{{ route('item.store') }}" enctype="multipart/form-data">
            ...
            @php
                $descriptions_ar = json_decode($item->description_ar);
                ...
                <div id="description-container">
                    <div class="description-line" id="description-lines">
                        @foreach ($descriptions as $index => $description)
                            <div class='d-flex description-line align-items-center'>
                                <input type="text" id="description" name="description[]" class="form-control mt-2"
                                    value="{{ $description }}" placeholder="English">
                                <input type="text" id="description_ar" name="description_ar[]" class="form-control mt-2"
                                    value="{{ $descriptions_ar[$index] }}" placeholder="Arabic">
                                @if ($index > 0)
                                    <button type="button" class="btn btn-secondary ml-2 remove-description-line"><i
            ...
            <div class="form-group" id="color-container">
                ...
                @foreach ($colors as $index => $color)
                    <div class="d-flex align-items-center color-inputs">
                        <input type="color" name="color[]" id="color" class="form-control color-form ml-3"
                            value="{{ $color->hex }}" required>
                        <input type="text" name="color-name[]" class="form-control color-form ml-5"
                            placeholder="Name in English" value="{{ $color->name }}" required>
                        <input type="text" name="color-name-ar[]" class="form-control color-form ml-2"
                            placeholder="Name in Arabic" value="{{ $color->name_ar }}" required>
                        @if ($index > 0)
                            <button type="button" class="btn btn-secondary ml-2 remove-color-line"><i
                                    class="fas fa-trash"></i></button>
                        @endif
                    </div>
                @endforeach
                ...
                <div id="style-container">
                    <div class="style-line" id="style-lines">
                        @foreach ($styles as $index => $style)
                            <div class='d-flex style-line align-items-center'>
                                <input type="text" name="style[]" id="style" class="form-control mt-2 style-input"
                                    placeholder="English" value="{{ $style }}">
                                <input type="text" name="style_ar[]" id="style_ar" class="form-control mt-2"
                                    placeholder="Arabic" value="{{ $styles_ar[$index] }}">
                                @if ($index > 0)
                                    <button type="button" class="btn btn-secondary ml-2 remove-style-line"><i
                                            class="fas fa-trash"></i></button>
                                @endif
                            </div>
                        @endforeach
                ...
                <div id="size-container">
                    <div class="size-line" id="size-lines">
                        @foreach ($sizes as $index => $size)
                            <div class="d-flex size-line align-items-center">
                                <input type="text" name="size[]" id="size" class="form-control mt-2 size-input"
                                    placeholder="Enter a size" value="{{ $size }}">
                                @if ($index > 0)
                                    <button type="button" class="btn btn-secondary ml-2 remove-size-line"><i
                                            class="fas fa-trash"></i></button>
                                @endif
                            </div>
                        @endforeach
            ...
            @php
                ...
                $careInstructions_ar = json_decode($item->care_instructions_ar);
            @endphp
            ...
            <div class="form-group">
                ...
                <div id="care-instructions-container">
                    <div class="care-instruction-line" id="instruction-lines">
                        @foreach ($careInstructions as $index => $careInstruction)
                            <div class='d-flex care-instruction-line align-items-center'>
                                <input type="text" id="care_instructions" name="care_instructions[]"
                                    class="form-control mt-2" placeholder="English" value="{{ $careInstruction }}">
                                <input type="text" id="care_instructions_ar" name="care_instructions_ar[]"
                                    class="form-control mt-2" placeholder="Arabic"
                                    value="{{ $careInstructions_ar[$index] }}">
                                @if ($index > 0)
                                    <button type="button" class="btn btn-secondary ml-2 remove-care-instruction-line"><i
                                            class="fas fa-trash"></i></button>
                                @endif
                            </div>
                        @endforeach
            ...
            <div class="form-group">
                ...
                <div class='d-flex'>
                    <textarea name="refund_policy" class="form-control large-input" id="refund_policy" placeholder="English">{{ $item->return_policy }}</textarea>
                    <textarea name="refund_policy_ar" class="form-control large-input" id="refund_policy_ar" placeholder="Arabic">{{ $item->return_policy_ar }}</textarea>
                </div>
            </div>
